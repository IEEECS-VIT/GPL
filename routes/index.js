            ...
            if (req.body.confirm_password === req.body.password)
            {
                ...
                var onInsert = function (err, docs)
                {
                    ...
                    else
                    {
                        ...
                        message.attach_alternative("<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd'>" +
                        ...
                        "                              <img src='http://www.gravitaspremierleague.com/images/gpllogo.png' height='50' style='outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; width: auto; max-width: 100%; float: left; clear: both; display: block;' align='left' /></td>" +
