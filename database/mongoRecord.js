...
var i,
	...
	user = function () {
		return {
			_id: "",
			dob: "",
			teamNo: "", // TODO: change to an array to make tracking matchday information for previous rounds simpler.
			managerName: "",
			passwordHash: "",
			email: "",
			phone: "",
...
try {
	faker = require("faker"); // eslint-disable-line global-require
}
catch (err) {
...
exports.users = function (flag, limit, index) {
	...
	for (i = 1; i <= limit; ++i) {
		...
		temp.passwordHash = "$2a$10$N7zcIGhNPPsW2rGLQWCDo.4XZb8Ket.MhxijAFbCueZbPFMn/P2Zu"; // Equivalent to 'gpl'
		temp.email = `testgpluser${i % 8 + 1}@gmail.com`; // specify a valid email address to test email functionality.
