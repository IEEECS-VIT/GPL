            ...
            for (i = 0; i < 20 && (wickets[1] < 10 && (Total[1] <= Total[0] && loop)); ++i)
            {
                ...
                for (j = 1; j <= 6; ++j)
                {
                    ...
                    if (batsman_performance_index <= 0 && !free_hit)
                    {
                        ...
                        for(k = 0; k < 6; ++k)
                        {
                            temp += balls_faced[+strike_index][k] * team_object[+!toss_index].bowl_rating[k];
                        }
